...
async function setcardsField(cardId) {
    ...
    await dranwCardsInfield(cardId, computerCardId);
...
async function dranwCardsInfield(cardId, computerCardId) {
...
async function updateScore() {
    state.score.scoreBox.innerHTML = `Win: ${state.score.playerScore} | Loser: ${state.score.computerScore}`; 
}
...
async function dranwSelectCard(index) {
...
function init() {
    ...
    dranwCards(5, playerSides.player1);
